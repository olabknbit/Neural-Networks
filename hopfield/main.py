def main():
    ...
    parser.add_argument('-vi', '--visualize', type=int, help='Generate image after x run,if -1 each run responsive',
    ...
    import hopfield_net
    accuracy = hopfield_net.run(images, args.width, args.height, args.seed, args.flip, args.visualize, args.bias,
                                args.steps, args.action == 'sync')
