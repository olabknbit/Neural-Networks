...
def generate_data(routes_lines, routes_stops, hours_n, hours_buses, trips_m, trips_transfers, nn, number_of_epochs):
    ...
    accuracy = regression.main(train_data_filename, test_data_filename, activation_f=activation_f,
                               activation_f_derivative=activation_f_derivative, visualize_every=None,
                               create_nn=None, save_nn=save_nn_filename, read_nn=save_nn_filename, number_of_epochs=number_of_epochs,
