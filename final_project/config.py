...
routes_lines = 1
routes_stops = 6
hours_n = 200 # how many rows of train and test data to generate (split 60:40)
...
monte_carlo_tests_medium = 51
monte_carlo_tests_big= 100
...
def get_test_params():
    return neat_tests, monte_carlo_tests_small, monte_carlo_tests_medium, monte_carlo_tests_big
